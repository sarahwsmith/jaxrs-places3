...
public class JerseyClient {
    private static final String baseUrl = "http://localhost:8080/places3";
	...
	form.add("where", "City name");
	form.add("poiOne", "First point of interest");
	form.add("poiTwo", "Second point of interest");
